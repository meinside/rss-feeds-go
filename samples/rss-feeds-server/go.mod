...
require github.com/meinside/rss-feeds-go v0.1.30
...
require (
	...
	github.com/meinside/gemini-things-go v0.1.36 // indirect
	github.com/meinside/randomized-string-generator-go v0.0.1 // indirect
	github.com/meinside/simple-scrapper-go v0.0.11 // indirect
